...
public class BatchDemoBroadcast {
    public static void main(String[] args) throws Exception {
        ...
        // 1.1.处理需要广播的数据，把数据集转换为map类型,map中的key就是用户姓名，value就是用户年龄
        DataSet<HashMap<String, Integer>> toBoradcast = tupleData.map(new MapFunction<Tuple2<String, Integer>, HashMap<String, Integer>>() {
            @Override
        ...
        }).withBroadcastSet(toBoradcast, "broadCastMapName");// 2.执行广播数据
